...
interface CalendarFormProps {
  remaining: number;
  limit: number;
  action: (formData: unknown) => Promise<ActionResult>;
}

export function CalendarForm({ remaining, limit, action }: CalendarFormProps) {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        toaster.success({
          ...
          description: "Redirecting to your calendars...",
        });
  ...
  const disabled = limitReached || isPending;
